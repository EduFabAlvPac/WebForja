          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative h-64 bg-gradient-to-br from-orange-100 to-orange-200 overflow-hidden">
                ...
                {/* Badge de industria */}
                <div className="absolute top-4 right-4 px-4 py-2 bg-brand-orange text-white font-bold rounded-full text-sm">
                  Retail
                </div>
              </div>
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold text-brand-navy mb-4">
                  Transformación Omnicanal en Retail
                </h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Implementamos una estrategia omnicanal completa para una cadena de 25 tiendas, integrando e-commerce, inventario en tiempo real y experiencia del cliente unificada.
                </p>

                {/* Resultados */}
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div>
                    <p className="text-3xl font-bold text-cyan-500">+180%</p>
                    <p className="text-sm text-gray-600">Ventas Online</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-orange-500">-40%</p>
                    <p className="text-sm text-gray-600">Costos Operativos</p>
                  </div>
                </div>
            ...
            >
              ...
              <div className="relative h-64 bg-gradient-to-br from-purple-100 to-purple-200 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <Factory className="w-32 h-32 text-purple-300" />
                </div>
                {/* Badge de industria */}
                <div className="absolute top-4 right-4 px-4 py-2 bg-brand-purple text-white font-bold rounded-full text-sm">
                  Manufactura
                </div>
              </div>
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Transformamos una planta manufacturera tradicional en una operación inteligente con IoT, análisis predictivo y automatización de procesos críticos.
                </p>

                {/* Resultados */}
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div>
                    <p className="text-3xl font-bold text-cyan-500">+65%</p>
                    <p className="text-sm text-gray-600">Productividad</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-orange-500">-50%</p>
                    <p className="text-sm text-gray-600">Defectos</p>
                  </div>
                </div>
