...
export default function MotorOperativoPage() {
  return (
      ...
      <section className="bg-gradient-to-br from-brand-navy via-brand-purple to-brand-navy py-20 md:py-28">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Motor <span className="text-brand-orange">Operativo</span>
          </h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Optimizamos operaciones, finanzas y talento para maximizar la eficiencia y el rendimiento.
          </p>
          <Link
            href="/servicios"
