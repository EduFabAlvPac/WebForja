...
import { ArrowRight, Phone, ClipboardCheck, Target, Check } from 'lucide-react'
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            >
              Desde el caos de datos hasta operaciones manuales, atacamos los puntos de dolor que impiden tu digitalización.
            </motion.p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <motion.p
              ...
              className="text-xl text-gray-600 max-w-3xl mx-auto"
            >
              Una suite de componentes modulares para construir tu ecosistema digital, paso a paso.
            </motion.p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-6xl mx-auto text-center mb-16">
            ...
            <motion.p
              ...
              className="text-xl text-gray-600 max-w-3xl mx-auto"
            >
              Nuestro proceso de 5 fases adaptado para una transformación digital exitosa, desde la visión hasta el escalado.
            </motion.p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <motion.p
              ...
              className="text-xl text-gray-600 max-w-3xl mx-auto"
            >
              Resultados reales de una empresa que pasó de operar en papel a liderar en el mundo digital.
            </motion.p>
          </div>
