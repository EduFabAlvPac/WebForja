/**
 * FORJA DIGITAL - Página Nosotros Localizada
 * 
 * Wrapper para la página de Nosotros con contexto de país.
 * Reutiliza los mismos componentes de la versión internacional.
 * 
 * @module app/[lc]/nosotros/page
 */
...
export default function NosotrosLocalePage() {
  const params = useParams()
  const lc = params.lc as string
  
  // Helper para construir links localizados
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              className="group"
            >
              <Link href={localizedLink("/nosotros/historia")} className="block">
            ...
            <motion.div
              ...
              className="group"
            >
              <Link href={localizedLink("/nosotros/equipo")} className="block">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-2xl hover:border-brand-orange/20 transition-all duration-300 h-full">
            ...
            <motion.div
              ...
              className="group"
            >
              <Link href={localizedLink("/nosotros/testimonios")} className="block">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-2xl hover:border-brand-orange/20 transition-all duration-300 h-full">
