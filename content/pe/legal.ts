/**
 * FORJA DIGITAL - Legal Content Overlay (Perú)
 * 
 * Overlay de contenido legal específico para Perú.
 * Se hace merge con el contenido base.
 * 
 * @module content/pe/legal
 */
...
export const legalContentOverlay: Partial<LegalContent> = {
  privacy: {
    intro: {
      text: 'Forja Digital, en adelante "nosotros" o "la empresa", es responsable del tratamiento de los datos personales que recopilamos a través de nuestro sitio web y servicios, conforme a la Ley N° 29733, Ley de Protección de Datos Personales del Perú.',
      responsible: 'Responsable del tratamiento: Forja Digital S.A.S. (Colombia), prestando servicios en Perú. Email: info@forjadigital.com',
    },
    dataCollection: {
      identification: [
        'Nombre completo',
    ...
    purposes: {
      ...
      legal: 'Cumplir con obligaciones legales conforme a la Ley N° 29733 del Perú y su reglamento.',
    },
    rights: {
      access: 'Conocer qué datos tenemos sobre ti y cómo los usamos (derechos ARCO).',
      rectification: 'Actualizar o corregir datos inexactos o incompletos.',
      deletion: 'Solicitar la cancelación de tus datos personales.',
      ...
      complaint: 'Presentar quejas ante la Autoridad Nacional de Protección de Datos Personales (ANPDP).',
    },
    internationalTransfer: {
      title: 'Flujo Transfronterizo de Datos',
      content: 'Tus datos pueden ser transferidos y procesados en Colombia, donde se encuentra nuestra sede principal. Garantizamos niveles de protección adecuados conforme a la Ley N° 29733.',
      note: 'Al utilizar nuestros servicios, consientes expresamente este flujo transfronterizo de datos personales.',
    },
  },
  terms: {
    acceptance: {
    ...
    services: {
      description: 'Forja Digital ofrece servicios de consultoría empresarial exportados desde Colombia para clientes en Perú, incluyendo pero no limitado a:',
      list: [
        {
    ...
    jurisdiction: {
      law: 'Estos términos se rigen por las leyes de Colombia, sin perjuicio de los derechos que te asisten bajo la legislación peruana.',
