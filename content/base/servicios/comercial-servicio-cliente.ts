/**
 * FORJA DIGITAL - Servicio Base: Comercial y Servicio al Cliente
 * 
 * Contenido BASE neutro del servicio.
 * Los overlays por país (content/{lc}/servicios/*) sobrescriben piezas específicas.
 * 
 * @module content/base/servicios/comercial-servicio-cliente
 */
...
export const baseComercialServicioData: ServicePageData = {
  ...
  targetProfile: {
    ...
    idealProfile: {
      title: 'Perfil Ideal',
      description: 'Directores Comerciales, Gerentes de Servicio, Directores Generales de empresas B2B o B2C con 5-50 personas en comercial y servicio. Empresas donde la experiencia del cliente es crítica para el crecimiento.'
    }
  },
  ...
  // CaseStudy y CTA se sobrescriben en overlays por país
  caseStudy: {
    company: {
    ...
    challenge: 'Alta adquisición pero baja retención de clientes.',
    solution: 'Sistema integrado comercial-servicio con seguimiento proactivo.',
    results: {
      before: [
    ...
    testimonial: {
      quote: 'El sistema integrado cambió completamente nuestra forma de trabajar.',
      author: 'Director Comercial',
      position: 'Empresa Internacional'
    }
  },
  ...
  cta: {
    ...
    secondary: {
      ...
      description: 'Agenda 30 minutos con uno de nuestros Forjadores para analizar tus desafíos.',
